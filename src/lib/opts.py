...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='D:/lsm/跟踪/Data/test/05_t/05001_1/img1/', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='D:/lsm/跟踪/CenterTrack/CenterTrack-master/model/model_last.pth',
